...
import com.example.teamb_project.databinding.FragmentTimeTableBinding;
...
public class TimeTableFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        b = FragmentTimeTableBinding.inflate( inflater, container, false);
    ...
    public void onClick(View v) {
         if(v.getId()==R.id.tv_link){
            //해당 강의로 이동
            Intent intent = new Intent(getActivity(), Stu_LectureDetailActivity.class);
    ...
    TextView getTextView(String data){
        TextView temp_tv = new TextView(getContext());
