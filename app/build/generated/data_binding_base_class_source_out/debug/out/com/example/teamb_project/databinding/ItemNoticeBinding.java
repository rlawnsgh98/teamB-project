...
public final class ItemNoticeBinding implements ViewBinding {
  ...
  private ItemNoticeBinding(@NonNull LinearLayout rootView, @NonNull ImageView ivDropDown,
  ...
  public static ItemNoticeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemNoticeBinding((LinearLayout) rootView, ivDropDown, linDetail, linViewDetail,
          tvNoticeContent, tvNoticeTitle, tvNoticeWritedate);
    }
