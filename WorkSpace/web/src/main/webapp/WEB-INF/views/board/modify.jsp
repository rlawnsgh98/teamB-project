...
<h3 class='container text-center board-title text-dark'>글수정</h3>

<form method="post" autocomplete="off" action="update.bo" enctype='multipart/form-data'>

<table class='w-px1000 insert-table'>
<tr style='margin-bottom:10px'>
	<th class='w-px140'>제목</th>
	<td><input type='text' name='title' class='ck in-title' title='제목' value='${vo.title}'></td>
</tr>
<tr>
	<th>내용</th>
	<td><textarea name='content' class='in-content ck resize-none' title='내용'>${vo.content}</textarea></td>
</tr>
<tr>
	<th>첨부파일</th>
