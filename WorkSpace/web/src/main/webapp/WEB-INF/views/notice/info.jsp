...
<div class='w-px1000 board-modify'>	
	<a href='update.bo?board_code=${info.board_code}' class='btn-board-black w-px80'>수정</a>
	<a href='delete.bo?board_code=${info.board_code}' class='btn-board-black w-px80'>삭제</a>
</div>
