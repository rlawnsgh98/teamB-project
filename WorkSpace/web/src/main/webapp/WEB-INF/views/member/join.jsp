					...
					<div class="tb_box">
						<form method='post' action='join' enctype='multipart/form-data'>
							<table class="join_table">
								...
								<tbody>
									<tr>
										<th class="tb_th"><label for="type" class="join_required">회원
												구분<span class="must">*</span>
										</label></th>
									...
									<tr>
										...
										<td><input type='text' name='birth' class='date' readonly>
											<a id='delete' style="display: none;"><i
									...
									<tr>
										<th class="tb_th"><label for="post" class="join_required">주소</label></th>
